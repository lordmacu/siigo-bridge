...
var tableDescriptions = map[string]string{
	"C03":    "Plan de Cuentas (PUC)",
	"C05":    "Parametros Empresa",
	"C06":    "Configuracion Cajas/POS",
	"INF":    "Definiciones de Informes",
	"Z001":   "Configuracion de Empresa",
	"Z003":   "Usuarios del Sistema",
	"Z06":    "Maestro de Configuracion (Sucursales/Bodegas/Inventario/Vendedores)",
	"Z06CP":  "Precios de Productos",
	"Z06MCCO": "Codigos de Producto",
	"Z07":    "Comprobantes/Documentos",
	"Z07S":   "Comprobantes Especiales",
	"Z07T":   "Tipos de Comprobantes",
	"Z08":    "Saldos de Cuentas",
	"Z09":    "Cartera (CxC/CxP)",
	"Z09CL":  "Clasificacion Cartera",
	"Z09H":   "Historico Cartera",
	"Z11":    "Impuestos",
	"Z11I":   "Impuestos Detalle",
	"Z11K":   "Retencion ICA",
	"Z11L":   "Liquidacion Impuestos",
	"Z11N":   "Notas Impuestos",
	"Z11P":   "Parametros Impuestos",
	"Z11U":   "Impuestos Unificados",
	"Z120":   "Empleados",
	"Z121":   "Empleados Detalle",
	"Z122":   "Conceptos Nomina",
	"Z123":   "Grupos Nomina",
	"Z12201": "Nomina Adicional",
	"Z03":    "Movimientos Contables",
	"Z04":    "Detalle Movimientos",
	"Z05":    "Movimientos Contables Detalle",
	"Z14":    "Presupuesto",
	"Z15":    "Cruce Documentos",
	"Z16":    "Cheques",
	"Z17":    "Terceros (Clientes/Proveedores)",
	"Z18":    "Flujos Tesoreria",
	"Z19":    "Vendedores",
	"Z19A":   "Vendedores Auxiliar",
	"Z232":   "Consolidados Nomina",
	"Z23":    "Consolidados Nomina",
	"Z244T":  "Tipos Activos Fijos",
	"Z25":    "Kardex/Movimientos Inventario",
	"Z26":    "Costos",
	"Z27":    "Facturacion",
	"Z27R":   "Resoluciones Facturacion",
	"Z28":    "Pedidos",
	"Z29":    "Cotizaciones",
	"Z34":    "Bodegas",
	"Z41":    "Listas de Precios",
	"Z49":    "Movimientos/Transacciones",
	"Z51":    "Resolucion DIAN",
	"Z70":    "Agenda de Cobro",
	"Z73":    "Centros de Costo",
	"Z80":    "Medios Magneticos (DIAN)",
	"Z9001ES": "Configuracion Sistema",
	"Z90ES":  "Modulos y Permisos",
	"Z90PO":  "Permisos por Opcion",
	"Z91PRO": "Catalogo de Programas",
	"Z92":    "Terceros Borrados",
	"ZCONN":  "Conexiones",
	"ZCTA!00": "Catalogo Cuentas",
	"ZDANE":  "Codigos DANE (Ciudades Colombia)",
	"ZICA":   "Retencion ICA",
	"ZIND":   "Indicadores",
	"ZM06":   "Movimientos Maestro Inventario",
	"ZPILA":  "Aportes Seguridad Social",
	"ZPRE":   "Presupuestos",
	"ZPRGN":  "Programacion",
	"ZRES":   "Resoluciones",
	"ZSUBCTA": "Subcuentas",
	"ZVEH":   "Vehiculos",
	"N03":    "Movimientos Nomina",
	"N04":    "Detalle Nomina",
	"N15":    "Cruce Documentos Nomina",
	"N16":    "Cheques Nomina",
	"N25":    "Kardex Nomina",
	"N26":    "Costos Nomina",
	"N27":    "Facturacion Nomina",
	"N28":    "Pedidos Nomina",
}
...
func inferFieldName(offset, length int, fType string) string {
	switch fType {
	case "date":
		return fmt.Sprintf("fecha_%d", offset)
	case "flag":
		return fmt.Sprintf("flag_%d", offset)
	case "code":
		return fmt.Sprintf("codigo_%d", offset)
	case "amount":
		return fmt.Sprintf("valor_%d", offset)
	case "numeric":
		return fmt.Sprintf("num_%d", offset)
	case "text":
		return fmt.Sprintf("texto_%d", offset)
	case "empty":
