...
export const api = {
  ...
  getRepopulateIntervals: (): Promise<Record<string, number>> => get('/repopulate-intervals'),
  saveRepopulateIntervals: (intervals: Record<string, number>) => post('/repopulate-intervals', { intervals }),
